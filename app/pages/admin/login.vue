  ...
  <div class="min-h-screen flex items-center justify-center bg-background px-4">
    <div class="w-full max-w-sm space-y-6">
      ...
      <button
        ...
        class="w-full flex items-center justify-center gap-3 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-medium text-foreground hover:bg-accent transition-colors disabled:opacity-50 cursor-pointer disabled:cursor-wait"
      >
...
// Redirect when user signs in (but not on undefined — auth still loading)
watch(user, (u) => {
